...
workflow runGFAseTrioPhase {
    ...
    output {
        File? gfase_TrioPhase_Maternal      = gfaseTrioPhase.outputMatAssembly
        File? gfase_TrioPhase_Paternal      = gfaseTrioPhase.outputPatAssembly
        File? gfase_TrioPhase_Unphased      = gfaseTrioPhase.outputTrioUnphasedAssembly
        File? gfase_TrioPhase_phase_chains  = gfaseTrioPhase.outputPhaseChains
